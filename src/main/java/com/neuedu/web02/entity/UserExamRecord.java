...
public class UserExamRecord extends UserExamRecordKey {
	...
	public UserExamRecord(Integer istest, Integer duringtime, Integer switchtime, Integer judge,
			BigDecimal totalgetscore, Integer submitpaper, String backup1, Integer backup2, Integer backup3) {
		super();
		this.istest = istest;
